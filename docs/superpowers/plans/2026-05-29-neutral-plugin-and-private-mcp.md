...
**Goal:** Make `xjb_coding` host-neutral and make `xjb_code` a standalone private MCP backend with simple tenant isolation.

**Architecture:** `xjb_coding` remains a skills-first plugin for every host and treats MCP as an optional enhancement. `xjb_code` remains an independent MCP Streamable HTTP daemon and adds tenant scope to workflow data without introducing heavy authentication.
...
### Task 2: Add Tenant Scope Tests In `xjb_code`

**Files:**
- Modify: `/Users/wmyeah/workSpace/projects/github.com/0xdevelop/xjb_code/task/task_test.go`
- Modify: `/Users/wmyeah/workSpace/projects/github.com/0xdevelop/xjb_code/api/api_mcp/api_mcp_test.go`
...
### Task 3: Implement Tenant Scope In `xjb_code`

**Files:**
- Modify: `/Users/wmyeah/workSpace/projects/github.com/0xdevelop/xjb_code/models/models.go`
- Modify: `/Users/wmyeah/workSpace/projects/github.com/0xdevelop/xjb_code/db/db.go`
- Modify: `/Users/wmyeah/workSpace/projects/github.com/0xdevelop/xjb_code/task/task.go`
- Modify: `/Users/wmyeah/workSpace/projects/github.com/0xdevelop/xjb_code/requirement/requirement.go`
- Modify: `/Users/wmyeah/workSpace/projects/github.com/0xdevelop/xjb_code/approval/approval.go`
- Modify: `/Users/wmyeah/workSpace/projects/github.com/0xdevelop/xjb_code/api/api_mcp/api_mcp.go`
- Modify: `/Users/wmyeah/workSpace/projects/github.com/0xdevelop/xjb_code/api/api_config/api_config.go`
- Modify: `/Users/wmyeah/workSpace/projects/github.com/0xdevelop/xjb_code/config/config.go`
...
**Files:**
- Modify: `README.md`
- Modify: `plugins/xjb-coding/skills/xjb-coding/SKILL.md`
- Modify: `plugins/xjb-coding/skills/xjb-coding-codex/SKILL.md`
- Modify: `/Users/wmyeah/workSpace/projects/github.com/0xdevelop/xjb_code/README.md`

- [ ] **Step 1: Update `xjb_coding` docs**

Make Claude Code and Codex peer hosts. State skills are default/fallback and MCP is optional enhancement.

- [ ] **Step 2: Update `xjb_code` docs**
...
**Files:**
- Read/check: `plugins/xjb-coding/.codex-plugin/plugin.json`
...
```bash
python3 /Users/wmyeah/.codex/skills/.system/plugin-creator/scripts/validate_plugin.py plugins/xjb-coding
```
